      ...
      <Popover
        ...
        className={({ open }) =>
          classNames(
            ...
            'bg-white dark:bg-zinc-900 shadow-sm lg:static lg:overflow-y-visible'
          )
        }
      >
        {({ open }) => (
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 dark:bg-zinc-900 dark:text-gray-200">
              <div className="relative flex justify-between xl:grid xl:grid-cols-12 lg:gap-2">
                <div className="flex md:absolute md:left-0 md:inset-y-0 lg:static xl:col-span-2">
                  ...
                  <img src={Logo} className="mr-3 h-8 text-3xl" alt="LemonPy Logo" />
                    <a href="/">
                    LemPy
                    </a>
                  </div>
                ...
                <div className="min-w-0 flex-1 md:px-8 lg:px-0 xl:col-span-6 ">
                                    <div className="flex items-center px-2 pl-4 py-4 md:max-w-xl md:mx-auto lg:max-w-none lg:mx-0 xl:px-0">
                                        <form onSubmit={e=>onSubmit(e)} className="md:w-full ">
                                            <label
                                                htmlFor="search"
                                                className="sr-only"
                                            >
             ...
             <div className="hidden lg:flex lg:items-center lg:justify-end xl:col-span-4">
                    ...
                    <NavLink to="/portfolio" className="mx-1 text-l dark:hover:text-white hover:text-blue-600 text-gray-600 dark:text-dark-txt text-md font-gilroy-semibold">
                        About
                    </NavLink>
