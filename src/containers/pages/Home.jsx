    ...
    <FullWidthLayout>
        ...
        <div className="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-1 lg:grid-cols-12">
            <div className="mr-auto place-self-center lg:col-span-7">
                ...
                mientras tanto puedes ir registrandote o ir viendo mis proyectos.</p>
                ...
                <a href="/IA-Projects" className="inline-flex items-center justify-center px-5 py-3 text-base font-medium text-center text-zinc-900 border border-zinc-300 rounded-lg hover:bg-zinc-100 focus:ring-4 focus:ring-zinc-100 dark:text-white dark:border-zinc-700 dark:hover:bg-zinc-700 dark:focus:ring-zinc-800">
                    ML Projects
                </a> 
            </div>
